...
/**
 * Gets topmost JSX element in a given element
 * @param {Object?} element if undefined, body of the file is used
 */
File.prototype.getJSXElement = function(element) {
  var jsxElement = null;

  recast.visit(element || this.body, {
    visitJSXElement: function(elem) {
      jsxElement = elem;
      this.abort();
    }
  });
